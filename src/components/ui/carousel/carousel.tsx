    ...
    return (
        <div ref={carouselRef} className="overflow-hidden">
            <div
                ...
                className={twMerge(
                    "flex",
                    orientation === "horizontal" ? "px-0.5" : "-mt-4 flex-col",
                    className
                )}
                {...props}
            />
...
const CarouselLink = ({ className, children, ...props }: GalleryLinkProps) => {
    return (
        <Link
            className={twMerge(
...
const CarouselTitle = React.forwardRef<
...
CarouselTitle.displayName = 'Carouselitle'
