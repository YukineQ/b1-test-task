...
export default function Shikimori<P extends ShikimoriUser>(
    ...
    return {
        ...
        authorization: "https://shikimori.one/oauth/authorize?client_id=qiY_yWBsGlFUm74WXk9fThWbbDjoB_w437r5GC10w1w&redirect_uri=http://localhost:3000&response_type=code&scope=",
